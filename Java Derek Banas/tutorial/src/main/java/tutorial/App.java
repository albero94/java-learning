...
public class App 
{
    ...
    public static void main( String[] args )
    {
        ...
        // ++i   i++
        // Math library, abs, ceil, floor, round, max, min, exp, log, log10, pow, sqrt, cbrt, hypot, sin, cos, tan...
        ...
        for(int x : oneTo10) System.out.print(x);
        System.out.println();
        ...
        // Logical operators: ! && ||
        int age = 12;
        if((age >= 5) && age <= 6) System.out.println("Go to Kindergarten");
        else if(age >= 7 && age <= 13) System.out.println("Go to Middle School");
        else if(age >= 14 && age <= 18) System.out.println("Go to High School");
